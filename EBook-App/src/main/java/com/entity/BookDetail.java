...
public class BookDetail {
	...
	public BookDetail(String bookName, String author, String price, String bookCategory, String category, String status,
			String photo, String userEmail, String phone) {
		super();
