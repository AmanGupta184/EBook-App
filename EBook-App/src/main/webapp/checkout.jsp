					...
					<div class="card-body">
						<form method="post" action="order">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">PinCode</label> <input type="text"
										name="pincode" class="form-control" id="inputPassword4" required="required">
								</div>
							</div>
							...
							<div class="text-center">
								<button type="submit" class="btn btn-warning text-white">Order Now</button> <a
									href="index.jsp" class="btn btn-success ml-1">Continue
									Shopping</a>
							</div>
						</form>
					</div>
